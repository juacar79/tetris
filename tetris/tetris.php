...
<script>
    ...
    function pintar(){
		...
		html+="<img src='blanco.jpg'>";
		html+="<a href='#' onClick='return rotarPieza()'><image src='flecha-ar.jpg'></a>";
		html+="<img src='blanco.jpg'>";
		html+="<br><a href='#' onClick='return moverPieza(-1)'><image src='flecha-izq.jpg'></a>";
		html+="<a href='#' onClick='return bajarPieza()'><image src='flecha-ab.jpg'></a>";
		html+="<a href='#' onClick='return moverPieza(1)'><image src='flecha-der.jpg'></a>";
		
        html+="<br />Lineas : " + lineas; 
        html+="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Record : " + record;
		html+="<br/><form><input type='button' onClick='ayuda()' value='Ayuda'/></form>";
